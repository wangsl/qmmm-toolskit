...
C     $Id: bound.i 2 2008-02-28 22:52:52Z wangsl $
c
c
c     ###################################################
...
c
      ...
      logical use_bounds,use_image
      logical use_replica,use_polymer
      common /bound/ polycut,polycut2,use_bounds,use_image,use_replica,
     &               use_polymer
