...
C     $Id: faces.i 2 2008-02-28 22:52:52Z wangsl $
c
c
c     ###################################################
...
c
c
c     maxnbr   maximum number of neighboring atom pairs
...
c
c
      integer anbr,nbr,nbrt
      common /face03/ anbr(2,maxatm),nbr(maxnbr),nbrt(maxnbr)
c
c
