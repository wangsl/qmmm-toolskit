...
public:
  double x, y, z;
  //Cartesian() { }
  Cartesian(double xx = 0.0, double yy = 0.0, double zz = 0.0) : 
    x(xx), y(yy), z(zz)
  { }
  // copy constructor
  ...
  const Cartesian operator -() const
  { return Cartesian(-x, -y, -z); }
  friend const Cartesian operator +(const Cartesian &c1, const Cartesian &c2)
  { return Cartesian(c1.x + c2.x, c1.y + c2.y, c1.z + c2.z); }
  friend const Cartesian operator -(const Cartesian &c1, const Cartesian &c2)
  { return Cartesian(c1.x - c2.x, c1.y - c2.y, c1.z - c2.z); }
  friend double operator *(const Cartesian &c1, const Cartesian &c2)
  { return c1.x * c2.x + c1.y * c2.y + c1.z * c2.z; }
  friend const Cartesian operator *(double r, const Cartesian &c)
  { return Cartesian(r*c.x, r*c.y, r*c.z); }
  friend const Cartesian operator *(const Cartesian &c, double r)
  { return r*c; }
  friend const Cartesian operator /(const Cartesian &c, double r)
...
public:
  ...
  const Cartesian &col1() const { return (Cartesian &) xx; }
  const Cartesian &col2() const { return (Cartesian &) xy; }
  const Cartesian &col3() const { return (Cartesian &) xz; }
  ...
  void set_col1(const Cartesian &c) 
  { xx = c.x; yx = c.y; zx = c.z; }
  void set_col2(const Cartesian &c) 
  { xy = c.x; yy = c.y; zy = c.z; }
  void set_col3(const Cartesian &c) 
			      ...
			      double r, double theta, double phi)
  {
    ...
    */
    j.set_col2((c-a).cross(b-a).as_unit_vector());
    j.set_col1((b-a).cross(j.col2()).as_unit_vector());
    j.set_col3(j.col1().cross(j.col2()).as_unit_vector());
